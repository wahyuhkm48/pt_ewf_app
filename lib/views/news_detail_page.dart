...
class NewsDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final creatorName = (article.creator != null && article.creator!.isNotEmpty) ? article.creator!.join(', ') : article.sourceName;
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(creatorName, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                      const Text('Creator', style: TextStyle(fontSize: 13, color: AppColors.textSecondary)),
                    ],
                  ),
                ],
              ),
