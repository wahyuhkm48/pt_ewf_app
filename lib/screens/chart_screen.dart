...
class _ChartScreenState extends State<ChartScreen> {
  ...
  final List<String> _tvSymbols = const [
    'Saxo:XAUUSD',    // Gold
    'Vantage:NIKKEI225',  // JPK - Nikkei 225
    'IG:HANGSENG',   // HKK - Hang Seng
  ];

  @override
  void initState() {
    super.initState();
    ChartRepository.instance.loadAll(); // cache-aware, aman dipanggil berkali-kali
  }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Tabel: header tetap, isi sekarang dari ChartRepository
            Container(
              decoration: BoxDecoration(
                border: Border.all(color: AppColors.divider),
              ...
              child: Column(
                children: [
                  ...
                  ListenableBuilder(
                    listenable: ChartRepository.instance,
                    builder: (context, _) {
                      final repo = ChartRepository.instance;
                      ...
                      if (repo.error != null && repo.data == null) {
                        return GestureDetector(
                          onTap: () => ChartRepository.instance.loadAll(forceRefresh: true),
                      ...
                      final candles = repo.forTab(_selectedTab);
                      ...
                      return Column(
                        children: candles
                            .map((candle) => _HistoryRow(candle: candle))
                            .toList(),
                      );
                    },
                  ),
...
class _HistoryRow extends StatelessWidget {
  ...
  const _HistoryRow({required this.candle});
